...
function PanelAuditoria() {
  ...
  return (
    <div style={{ padding: 40, color: "#00ffd9", minHeight: "100vh" }}>
      <h2 style={{ fontWeight: "bold", fontSize: 32 }}>Panel de Auditoría ADNIA</h2>
      <p>
        Bienvenido/a, <b>{usuario}</b>. Aquí puedes auditar procesos, revisar logs y exportar informes.
      </p>
      <button
        style={{
          background: "#ff3c48",
      ...
      <div style={{ marginTop: 32 }}>
        ...
        <ul>
          <li>Revisar registros de actividad</li>
