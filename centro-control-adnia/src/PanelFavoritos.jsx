...
function PanelFavoritos() {
  ...
  return (
    <div style={{ padding: 40, color: "#00ffd9", minHeight: "100vh" }}>
      <h2 style={{ fontWeight: "bold", fontSize: 32 }}>Panel Favoritos ADNIA</h2>
      <p>
        Bienvenido/a, <b>{usuario}</b>. Aquí puedes consultar tus consultas, expedientes o jurisprudencia favorita.
      </p>
      <button
        style={{
          background: "#ff3c48",
