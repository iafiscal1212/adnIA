...
function PanelBlockchain() {
  ...
  return (
    <div style={{ padding: 40, color: "#00ffd9", minHeight: "100vh" }}>
      <h2 style={{ fontWeight: "bold", fontSize: 32 }}>Panel Blockchain ADNIA</h2>
      <p>
        Bienvenido/a, <b>{usuario}</b>. Aquí puedes consultar trazabilidad blockchain, firmar documentos y más.
      </p>
      <button
        style={{
          background: "#ff3c48",
      ...
      <div style={{ marginTop: 32 }}>
        <h3>Acciones blockchain</h3>
        <ul>
          <li>Registrar evento en blockchain</li>
          <li>Consultar trazabilidad</li>
          <li>Exportar bloque</li>
        </ul>
      </div>
    </div>
  );
...
export default PanelBlockchain;
