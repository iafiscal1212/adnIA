...
# ¡HERRAMIENTA RESTAURADA A LA VERSIÓN LOCAL!
@tool
def analyze_document(file_path: str) -> str:
    """
    Analiza el contenido de un archivo (PDF o imagen) y devuelve el texto extraído.
...
# ... (Aquí irían tus otras herramientas de búsqueda que ya tenías) ...
...
# --- El resto del archivo (Fábrica de LLMs, Prompts, Agentes) no cambia ---
# ... (Manten el resto de tu código de adnia_agents.py como estaba) ...
